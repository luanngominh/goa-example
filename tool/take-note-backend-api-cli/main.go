...
import (
	...
	"github.com/luanngominh/goa-example/client"
	"github.com/luanngominh/goa-example/tool/cli"
...
func main() {
	...
	app := &cobra.Command{
		Use:   "Take Note Backend API-cli",
		Short: `CLI client for the Take Note Backend API service`,
	}
	...
	c.UserAgent = "Take Note Backend API-cli/0"
