...
//
// API "Take Note Backend API": CLI Commands
//
// Command:
// $ goagen
// --design=github.com/luanngominh/goa-example/goa/design
// --out=$(GOPATH)/src/github.com/luanngominh/goa-example
// --version=v1.3.1
